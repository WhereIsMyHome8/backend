...
CREATE TABLE `interest_area` (
  ...
  `dongcode` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  PRIMARY KEY (`user_id`,`dongcode`),
  KEY `fk_user_has_dongcode_dongcode1_idx` (`dongcode`),
  KEY `fk_user_has_dongcode_user1_idx` (`user_id`),
  CONSTRAINT `fk_user_has_dongcode_dongcode1` FOREIGN KEY (`dongcode`) REFERENCES `dongcode` (`dongCode`),
  CONSTRAINT `fk_user_has_dongcode_user1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
...
-- Dump completed on 2022-11-02 18:10:50
